...
mask_geo = geo_path + f'geoid{args.g}_prealigned.geo'
prealign_geo = geo_path + f'geoid{args.g}_prealigned.geo'
align_tel_geo_itr1 = geo_path + f'geoid{args.g}_tel_aligned_itr1.geo'
align_tel_geo_itr2 = geo_path + f'geoid{args.g}_tel_aligned_itr2.geo'
align_tel_geo_itr3 = geo_path + f'geoid{args.g}_tel_aligned_itr3.geo'
align_tel_geo_itr4 = geo_path + f'geoid{args.g}_tel_aligned_itr4.geo'
align_tel_geo = geo_path + f'geoid{args.g}_tel_aligned.geo'
align_dut_geo_itr1 = geo_path + f'geoid{args.g}_dut_aligned_itr1.geo'
align_dut_geo_itr2 = geo_path + f'geoid{args.g}_dut_aligned_itr2.geo'
align_dut_geo_itr3 = geo_path + f'geoid{args.g}_dut_aligned_itr3.geo'
align_dut_geo = geo_path + f'geoid{args.g}_dut_aligned.geo'

if not args.o:

    print('\n\n###### create mask #########')
    corry_cmd = f'{corry_bin} -c {corry_config_create_mask_all} -o number_of_events={args.n} -o output_directory={output_dir} -o detectors_file={rough_geo} -o detectors_file_updated={mask_geo} -o histogram_file=geoid{args.g}_masking.root -o EventLoaderEUDAQ2.file_name={current_tel_file} -o EventLoaderEUDAQ2:Monopix2_0.file_name={current_dut_file}'
    os.system(corry_cmd)

    print('\n\n###### pre-alignment all #########')
    corry_cmd = f'{corry_bin} -c {corry_config_prealign_all} -o number_of_events={args.n} -o output_directory={output_dir} -o detectors_file={mask_geo} -o detectors_file_updated={prealign_geo} -o histogram_file=geoid{args.g}_prealigned_all.root -o EventLoaderEUDAQ2.file_name={current_tel_file} -o EventLoaderEUDAQ2:Monopix2_0.file_name={current_dut_file}'
    os.system(corry_cmd)


    print('\n\n###### alignment telescope 1 #########')
    corry_cmd = f'{corry_bin} -c {corry_config_align_tel} -o number_of_events={args.n} -o output_directory={output_dir} -o detectors_file={prealign_geo} -o detectors_file_updated={align_tel_geo_itr1} -o histogram_file=geoid{args.g}_tel_aligned_itr1.root -o EventLoaderEUDAQ2.file_name={current_tel_file} -o EventLoaderEUDAQ2:Monopix2_0.file_name={current_dut_file}'
    os.system(corry_cmd)

    print('\n\n###### alignment telescope 2 #########')
    corry_cmd = f'{corry_bin} -c {corry_config_align_tel} -o number_of_events={args.n} -o output_directory={output_dir} -o detectors_file={align_tel_geo_itr1} -o detectors_file_updated={align_tel_geo_itr2} -o histogram_file=geoid{args.g}_tel_aligned_itr2.root -o EventLoaderEUDAQ2.file_name={current_tel_file} -o EventLoaderEUDAQ2:Monopix2_0.file_name={current_dut_file}'
    os.system(corry_cmd)

    print('\n\n###### alignment telescope 3 #########')
    corry_cmd = f'{corry_bin} -c {corry_config_align_tel} -o number_of_events={args.n} -o output_directory={output_dir} -o detectors_file={align_tel_geo_itr2} -o detectors_file_updated={align_tel_geo_itr3} -o histogram_file=geoid{args.g}_tel_aligned_itr3.root -o EventLoaderEUDAQ2.file_name={current_tel_file} -o EventLoaderEUDAQ2:Monopix2_0.file_name={current_dut_file}'
    os.system(corry_cmd)

    print('\n\n###### alignment telescope 4 #########')
    corry_cmd = f'{corry_bin} -c {corry_config_align_tel} -o number_of_events={args.n} -o output_directory={output_dir} -o detectors_file={align_tel_geo_itr3} -o detectors_file_updated={align_tel_geo_itr4} -o histogram_file=geoid{args.g}_tel_aligned_itr4.root -o EventLoaderEUDAQ2.file_name={current_tel_file} -o EventLoaderEUDAQ2:Monopix2_0.file_name={current_dut_file}'
    os.system(corry_cmd)

    print('\n\n###### alignment telescope final #########')
    corry_cmd = f'{corry_bin} -c {corry_config_align_tel} -o number_of_events={args.n} -o output_directory={output_dir} -o detectors_file={align_tel_geo_itr4} -o detectors_file_updated={align_tel_geo} -o histogram_file=geoid{args.g}_tel_aligned.root -o EventLoaderEUDAQ2.file_name={current_tel_file} -o EventLoaderEUDAQ2:Monopix2_0.file_name={current_dut_file}'
    os.system(corry_cmd)



    print('\n\n###### alignment dut 1 #########')
    corry_cmd = f'{corry_bin} -c {corry_config_align_dut} -o number_of_events={args.n} -o output_directory={output_dir} -o detectors_file={align_tel_geo} -o detectors_file_updated={align_dut_geo_itr1} -o histogram_file=geoid{args.g}_dut_aligned_itr1.root -o EventLoaderEUDAQ2.file_name={current_tel_file} -o EventLoaderEUDAQ2:Monopix2_0.file_name={current_dut_file}'
    os.system(corry_cmd)

    print('\n\n###### alignment dut 2 #########')
    corry_cmd = f'{corry_bin} -c {corry_config_align_dut} -o number_of_events={args.n} -o output_directory={output_dir} -o detectors_file={align_dut_geo_itr1} -o detectors_file_updated={align_dut_geo_itr2} -o histogram_file=geoid{args.g}_dut_aligned_itr2.root -o EventLoaderEUDAQ2.file_name={current_tel_file} -o EventLoaderEUDAQ2:Monopix2_0.file_name={current_dut_file}'
    os.system(corry_cmd)

    print('\n\n###### alignment dut 3 #########')
    corry_cmd = f'{corry_bin} -c {corry_config_align_dut} -o number_of_events={args.n} -o output_directory={output_dir} -o detectors_file={align_dut_geo_itr2} -o detectors_file_updated={align_dut_geo_itr3} -o histogram_file=geoid{args.g}_dut_aligned_itr3.root -o EventLoaderEUDAQ2.file_name={current_tel_file} -o EventLoaderEUDAQ2:Monopix2_0.file_name={current_dut_file}'
    os.system(corry_cmd)

    print('\n\n###### alignment dut final #########')
    corry_cmd = f'{corry_bin} -c {corry_config_align_dut} -o number_of_events={args.n} -o output_directory={output_dir} -o detectors_file={align_dut_geo_itr3} -o detectors_file_updated={align_dut_geo} -o histogram_file=geoid{args.g}_dut_aligned.root -o EventLoaderEUDAQ2.file_name={current_tel_file} -o EventLoaderEUDAQ2:Monopix2_0.file_name={current_dut_file}'
    os.system(corry_cmd)
